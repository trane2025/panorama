...
const objInitial = {
    ...
    items: {
        brus: {
            id: 'brus',
            title: 'Брус',
            description: 'Мы применяем стеклопакеты толщиной от 32 до 40 мм, состоящие их 2-х или из 3- стекол. Мы предлагаем очень широкий выбор стеклопакетов, в зависимости от требований по дизайну и условий эксплуатации оконных конструкций. <br/> Современные технологии нанесения специальных покрытий на стёкла позволяют придавать стеклопакетам уникальные свойства, например: пропускать солнечный свет, но задерживать жару отражать тепло от отопительных приборов обратно в помещение быть цветными с внешней стороны, но не окрашивать, проходящий сквозь них свет',
            ...
            <Container>
                ...
                <WraperContent>
                    ...
                    <TextWraper>
                        ...
                        {getFormatedText(obj.items[obj.checked].description)}
                    </TextWraper>
                    <ImageWraper>
