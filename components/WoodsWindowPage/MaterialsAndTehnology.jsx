...
const objInitial = {
    ...
    items: {
        brus: {
            id: 'brus',
            title: 'Брус',
            description: 'Деревянные окна Панорама изготавливаются из 3-х слойного клееного бруса. Данный материал стал широко применяться около сорока лет назад и быстро завоевал популярность на рынке пиломатериалов. br И это не удивительно, ведь клеёный брус не имеет недостатков, характерных для бруса из массива, таких как: неравномерная влажность, растрескивание, различные пороки, нестабильная геометрия.',
            image: '/images/woodsWindow/materialAndTexnology/image1.jpg'
        },
        steklopaket: {
            id: 'steklopaket',
            title: 'Стеклопакет',
            description: 'Мы применяем стеклопакеты толщиной от 32 до 40 мм, состоящие их 2-х или из 3- стекол. И предлагаем очень широкий выбор стеклопакетов, в зависимости от требований по дизайну и условий эксплуатации оконных конструкций. br Современные технологии нанесения специальных покрытий на стёкла позволяют придавать стеклопакетам уникальные свойства, например: br 1) пропускать солнечный свет, но задерживать жару br 2) отражать тепло от отопительных приборов обратно в помещение br 3) быть цветными с внешней стороны, но не окрашивать, проходящий сквозь них свет',
            image: '/images/woodsWindow/materialAndTexnology/image2.jpg'
        },
        furnitura: {
            id: 'furnitura',
            title: 'Фурнитура',
            description: 'Мы применяем поворотно - откидную фурнитуру австрийской фирмы МАСО, которая имеет запорные элементы по всему периметру створки и имеет широкие возможности по регулировке положения створки относительно рамы и уровня прижима запорных элементов. br Все элементы фурнитуры имеют стойкое антикоррозийное покрытие, очень хорошо удерживающее смазку. Производитель гарантирует безотказную работу в течение 20 000 циклов открываний/закрываний. Широкая цветовая гамма оконных ручек и декоративных накладок на петли даёт большие возможности по дизайну.',
            image: '/images/woodsWindow/materialAndTexnology/image3.jpg'
        },
        kraskiLaki: {
            id: 'kraskiLaki',
            title: 'Краски / лаки',
            description: 'Применяемые нами материалы ведущей европейской компании TEKNOS обеспечивают надёжную защиту деревянных частей от разрушительных воздействий грибка, солнца и воды. Данные материалы на водной основе, экологически чистые и имеют большой выбор по цветам. br Самые уязвимые места - нижние горизонтальные части створок и рам покрыты специальными алюминиевыми накладками. Краска на наших первых изделиях, выпущенных в начале 2000 - х годов, прекрасно сохранилась и по сей день, что полностью опровергает миф о том, что деревянные окна нужно каждый год подкрашивать и ремонтировать.',
...
function MaterialsAndTehnology() {
    ...
    const getFormatedText = (text) => {
        return text.description?.split('br').map((str, i) => {
            return (
