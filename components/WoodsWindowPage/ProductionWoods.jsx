                    ...
                    <ItemProduction backColor='#fef0d4'>
                        ...
                        <TextList>
                            ...
                            <ul>
                                <li>
                                    <p>
                                        трёхслойный клееный брус толщиной 78&nbsp;мм
                                    </p>
                                </li>
                                <li>
                                    <p>
                    ...
                    <ItemProduction backColor='#202336'>
                        ...
                        <TextList colorText='white'>
                            ...
                            <ul>
                                <li>
                                    <p>
                                        трёхслойный клееный брус
                                    </p>
                                </li>
                                <li>
                                    <p>
                                        алюминиевые накладки ALURON по&nbsp;периметру
                                    </p>
                                </li>
                                <li>
                                    <p>
                                        общая толщина дерево-алюминиевого профиля 87&nbsp;мм
                                    </p>
                                </li>
                                <li>
                                    <p>
                                ...
                                <li>
                                    <p>
                                        поворотно-откидная фурнитура с&nbsp;микропроветриванием MACO
                                    </p>
                                </li>
                                <li>
                                    <p>
                                ...
                                <li>
                                    <p>
                                        четыре контура мягкого резинового уплотнителя DEVENTER
                                    </p>
                                </li>
                            </ul>
                        </TextList>
